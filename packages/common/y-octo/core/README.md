...
[AFFiNE](https://affine.pro) is using y-octo in production. There are [Electron](https://affine.pro/download) app and [Node.js server](https://github.com/ALEEF02/AFFiNE/tree/canary/packages/backend/native) using y-octo in production.
...
[AFFiNE]: https://github.com/aleef02/affine
