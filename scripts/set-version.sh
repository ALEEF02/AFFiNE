...
update_app_stream_version() {
  ...
  #     <url>https://github.com/ALEEF02/AFFiNE/releases/tag/v0.21.0</url>
  #   </release>
  # </releases>
  ...
  sed -i.bak -E "s|<url>https://github.com/ALEEF02/AFFiNE/releases/tag/v[^<]*</url>|<url>https://github.com/ALEEF02/AFFiNE/releases/tag/v$new_version</url>|" "$file_path"
